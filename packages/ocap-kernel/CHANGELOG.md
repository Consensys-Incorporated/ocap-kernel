...
- Add `orphanKernelObject` to the kernel store, which gives up the kernel's record of who owns an object ([#1090](https://github.com/Consensys-Incorporated/ocap-kernel/pull/1090))
