...
- A vat whose worker launched but whose kernel-side registration failed is torn down and marked for cleanup, rather than left running with no record ([#1093](https://github.com/Consensys-Incorporated/ocap-kernel/pull/1093))
