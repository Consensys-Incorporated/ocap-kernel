...
- **BREAKING:** Bump `better-sqlite3` from `^12.4.1` to `^13.0.3`, which requires Node 22 or later — the same floor this package already declares ([#1045](https://github.com/MetaMask/ocap-kernel/pull/1045))
