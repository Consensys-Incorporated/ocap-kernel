...
- The wasm driver clears `_inTx` when aborting or committing a transaction throws, and discards the transaction that a failed COMMIT can leave open ([#1021](https://github.com/MetaMask/ocap-kernel/pull/1021))
